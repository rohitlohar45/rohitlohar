                  ...
                  {({ isValid }) => (
                    <Form className="mt-6 flex flex-col gap-3">
                            ...
                            {({
                              ...
                              <>
                                <input
                                  ...
                                  type="text"
                                  placeholder="Email"
                                  className="placeholder-font-normal placeholder-text-gray-400 w-full rounded-lg border-none bg-gray-50 font-semibold text-gray-800 focus-within:border-2 focus-within:border-blue-600 focus-within:ring-blue-600"
                                />
                      ...
                      <button
                        aria-label="open send mail modal"
                        type="submit"
                        className="mt-4 w-full rounded-full bg-gray-50 px-4 py-3 text-center text-lg font-semibold text-gray-900 transition-colors duration-150 hover:bg-blue-100"
                        disabled={!isValid}
                      >
                        {isSendingMail ? (
